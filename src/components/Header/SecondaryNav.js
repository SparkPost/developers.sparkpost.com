...
class SecondaryNav extends React.Component {
  ...
  render() {
    ...
    return (
      <Nav>
        <SecondaryNavLink to="https://status.sparkpost.com"><StatusIcon status={this.state.status} /> Status</SecondaryNavLink>
        <SecondaryNavLink to="https://sparkpost.com/blog">Blog</SecondaryNavLink>
        <SecondaryNavLink to="https://sparkpost.com/docs">Support</SecondaryNavLink>
