...
const Info = props => (
  ...
  >
    <g>
      <path d="m18.4 15v-3.4h3.2v3.4h-3.2z m1.6 18.4c7.3 0 13.4-6.1 13.4-13.4s-6.1-13.4-13.4-13.4-13.4 6.1-13.4 13.4 6.1 13.4 13.4 13.4z m0-30c9.2 0 16.6 7.4 16.6 16.6s-7.4 16.6-16.6 16.6-16.6-7.4-16.6-16.6 7.4-16.6 16.6-16.6z m-1.6 25v-10h3.2v10h-3.2z" />
    </g>
  </Svg>
)
        ...
        <Row>
          <Column xs="8" xsOffset="3">
            ...
            <p>
              ...
              <i>consectetur adipisicing elit</i>. <u>In temporibus dolorum</u>,{' '}
              <code>sint ex vitae</code>! Ducimus commodi eum, cumque rerum nam
              corrupti eligendi repellat. Maiores quo rem vitae quos, facere ea!
            </p>
            <h2>Heading 2</h2>
            <p>
            ...
            <Banner status="info">
              ...
              <BannerContent>
                <BannerTitle>
                  SparkPost makes it easy to send with Magento
                </BannerTitle>
                <p>
                  If you're importing recipients from a previous provider, be
                  sure to also import your suppressions.
                </p>
                <br />
